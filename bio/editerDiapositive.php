...
<table width="1220" height="499" border="0" align="center" style="border:#999999 2px double;margin:40px auto 40px auto">
  ...
  <tr>
    <td height="40" colspan="3"><div align="center" class="titleRubrique">
      <p class="titreRubriquePrincipale"> Editer Diapositive</p>
    </div></td>
  </tr>
  <tr>
...
$query="select * from diaporama where id='".$_GET['id']."' limit 1";
$res=$pdo->query( $query);
if($res)
{
...
?>
<form action="saveDiapositive.php?id=<?php echo $data['id']; ?>" method="post">
