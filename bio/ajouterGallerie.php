...
<p class="titreRubriquePrincipale">Ajouter gallerie <?php echo  $data['titre']; ?></p>
</div>
<?php 
}
?>
  ...
  <tr>
    ...
    <td width="958" valign="top"><form action="addGallerie.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
