...
<table width="1220" height="499" border="0" align="center" style="border:#999999 2px double;margin:40px auto 40px auto">
  ...
  <tr>
    <td height="40" colspan="3"><div align="center" class="titleRubrique">
      <p class="titreRubriquePrincipale"> Editer Plan de Masse</p>
    </div></td>
  </tr>
  <tr>
...
<form action="savePlanMasse.php?id=<?php echo $data['id']; ?>" method="post" name="editGal">
  ...
  <table width="730" height="140"   border="0" align="center" cellpadding="0" cellspacing="0" >
     ...
     <tr><td>Image Actuel : </td><td><img src="../<?php echo $data['path']; ?>"  /><br /> <a href="javascript:affichage_popup('modifierImgPlanMasse.php?id=<?php echo $data['id']; ?>','Modifier IMG');">Modifier</a><br /><br /></td></tr>    
