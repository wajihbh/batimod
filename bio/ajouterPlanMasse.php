...
<p class="titreRubriquePrincipale">Ajouter Plan de masse <?php echo  $data['titre']; ?></p>
</div>
<?php 
}
?>
  ...
  <tr>
    ...
    <td width="958" valign="top"><form action="addPlanMasse.php" method="post" enctype="multipart/form-data">
