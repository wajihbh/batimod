  ...
  <tr>
    <td width="159" height="376" valign="top"><?php include("rightCol.php"); ?>
		<table width="136">
			<tr>
				...
				<td width="119"><a href="ajouterGallerie.php?id=<?php echo $idProj; ?>" class="linkMenu">Ajouter gallerie</a></td>
			</tr>
	  </table>
  	</td>
   ...
   <table width="1250" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        ...
        <td width="189" height="23"><div align="center" class="bakgrnTitleCol" ><span class="titreCol">Image</span></div></td>
        ...
        <td width="120" height="23"><div align="center" class="bakgrnTitleCol" ><span class="titreCol">Action</span></div></td>
      </tr>
     <?php include("getListImgGalerie.php");?>
    </table>
