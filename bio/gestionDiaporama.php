...
<table width="1220" height="497" border="0" align="center" style="border:#999999 2px double;margin:40px auto 40px auto">
 <tr>
  ...
  <tr>
    ...
    <div align="center">
      <div align="center">
       <p><span class="titleRubrique" >Gestion du diaporama</span></p>
      </div>
    </div>
    </td>
  </tr>
  <tr>
    <td width="159" height="376" valign="top"><?php include("rightCol.php"); ?>
		<table width="136">
			<tr>
				...
				<td width="119"><a href="ajouterDiapositive.php" class="linkMenu">Ajouter une Diapositive</a></td>
			</tr>
	  </table>
  	</td>
   ...
   <table width="1250" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     ...
     <?php include("getListDiaporama.php");?>
    </table>
